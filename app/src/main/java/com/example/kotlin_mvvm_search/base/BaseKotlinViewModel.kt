...
import com.example.kotlin_mvvm_search.util.SnackbarMessage
import com.example.kotlin_mvvm_search.util.SnackbarMessageString
...
open class BaseKotlinViewModel : ViewModel() {
    ...
    fun showSnackbarStr(msg:String) {
        snackbarMessageString.value = msg
    }

    /**
     *BaseKotlinActivity에서 쓰는 함수
     */
